...
class ContractContract(models.Model):
    ...
    def action_draft(self):
        # Clear Signature & Set it to draft
    ...
    def action_cancel(self):
        return self.write({"active": False, "state": "cancel"})
    ...
    def _get_lines_to_invoice(self, date_ref):
        ...
        def can_be_invoiced(line):
            return (
                not line.is_canceled
                and line.recurring_next_date
                and line.recurring_next_date <= date_ref
            )
